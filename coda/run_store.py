...
class RunStore:
    ...
    # 读写 write task state 相关的持久化数据，保证状态可以复用。
    ...
    # 读写 append trace 相关的持久化数据，保证状态可以复用。
    ...
    # 读写 write report 相关的持久化数据，保证状态可以复用。
