...
class ContextManager:
    ...
    # 处理 render sections without reduction 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 compute section floors 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 render sections 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 render relevant memory 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 per note budget 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 render history section 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 compressed history entries 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 reusable file summary 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 summarize old tool item 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 raw history text 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 render history item 相关逻辑，支撑当前模块的主要流程。
    ...
    # 处理 assemble prompt 相关逻辑，支撑当前模块的主要流程。
