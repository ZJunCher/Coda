...
class TaskState:
    ...
    # 更新 record attempt 对应的运行状态，让任务进度可追踪。
    def record_attempt(self):
        # attempt 统计的是“模型被调用了几轮”，不等于 tool_steps。
        self.attempts += 1
        return self

    # 更新 record tool 对应的运行状态，让任务进度可追踪。
    ...
    # 更新 finish success 对应的运行状态，让任务进度可追踪。
