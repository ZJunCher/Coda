...
# 处理 normalize versioned base url 相关逻辑，支撑当前模块的主要流程。
...
# 解析 extract openai text 相关输入，把原始内容转成结构化数据。
...
# 解析 extract openai text from sse 相关输入，把原始内容转成结构化数据。
...
# 解析 extract openai response from sse 相关输入，把原始内容转成结构化数据。
...
# 解析 extract usage cache details 相关输入，把原始内容转成结构化数据。
...
# 解析 extract anthropic text 相关输入，把原始内容转成结构化数据。
