...
# 验证 load benchmark validates fixed schema 场景，确保对应功能按预期工作。
...
# 验证 load benchmark rejects missing required task fields 场景，确保对应功能按预期工作。
...
# 验证 run fixed benchmark uses fresh fixture copy and fresh run directory 场景，确保对应功能按预期工作。
...
# 验证 run fixed benchmark reports metadata and success definition 场景，确保对应功能按预期工作。
...
# 验证 run fixed benchmark covers recovery and durable contract rows 场景，确保对应功能按预期工作。
...
# 验证 run harness regression v2 writes named artifact 场景，确保对应功能按预期工作。
...
# 验证 run task anchors paths to fixture copy even inside repo workspace 场景，确保对应功能按预期工作。
...
# 验证 summarize rows counts failure categories 场景，确保对应功能按预期工作。
