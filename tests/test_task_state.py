...
# 验证 task state starts running with empty progress 场景，确保对应功能按预期工作。
...
# 验证 task state records success and final answer 场景，确保对应功能按预期工作。
...
# 验证 task state records step limit stop reason 场景，确保对应功能按预期工作。
...
# 验证 task state records retry limit stop reason 场景，确保对应功能按预期工作。
...
# 验证 task state snapshot keeps final answer 场景，确保对应功能按预期工作。
...
# 验证 task state snapshot keeps checkpoint reference without body 场景，确保对应功能按预期工作。
